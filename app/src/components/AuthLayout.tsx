    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-zinc-950 text-zinc-300">
        <div className="text-center">
          ...
          <p className="text-sm">Uruchamianie otwartego workspace…</p>
        </div>
      </div>
    );
  }
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-64">
                <div className="px-3 py-2 text-xs text-muted-foreground">
                  Otwarty workspace: przykładowe dane są widoczne od razu, a w widoku
                  Struktura możesz utworzyć własną firmę z kopiami receptur, norm i surowców.
                </div>
              </DropdownMenuContent>
            </DropdownMenu>
          </SidebarFooter>
